---
title: '차세대 번들러 비교 및 분석'
description: '번들러는 왜 필요하고 어떻게 발전되어 가고 있을까?'
image: ''
tags:
  - bundler
draft: false
...
![230807-215932](/img/bundlers/230807-215932.png)

이 포스트에선 그 중 많이 알려진 `webpack` `rollup` `esbuild` `vite`에 대해 등장 순서대로 다뤄 볼 예정입니다.

## Webpack

![230807-215955](/img/bundlers/230807-215955.png)
...
<img src="/img/bundlers/230807-220207.png" width="128px" alt="esbuild" />
...
<img src="/img/bundlers/230807-220324.png" width="128px" alt="vite" />
